...
\address{+33 7 81 61 89 65 \\ eylea.piouceau@ens-paris-saclay.fr} % Contact information
...
\begin{rReferences}
	\vspace{-0.5em}
    \item \textit{Academic Reference:} Uriel Hazan, research professor at the ENS Paris-Saclay $\diamond$ uriel.hazan@ens-paris-saclay.fr
    \item \textit{Professional Reference:} Maude Guillier, research director at the IBPC $\diamond$ maude.guillier@ibpc.fr
\end{rReferences}
