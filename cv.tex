...
\usepackage{setspace}
\setstretch{0.95} % Réduit l'interligne à 95% de la normale

%------------------------------------------------

\name{Eyléa Piouceau}

\address{+33 7 81 61 89 65 \\ \texttt{eylea.piouceau@ens-paris-saclay.fr}} % Contact information

%----------------------------------------------------------------------------------------

\renewenvironment{rReferences}
{\vspace{-0.25em}\medskip\textbf{Références}\medskip\hrule
\begin{list}{}
...
\begin{document}
	...
	\begin{minipage}[c]{0.22\textwidth}
		\includegraphics[height=3cm]{img/pp.jpeg}
	\end{minipage}%
	\begin{minipage}[c]{0.56\textwidth}
		\centering
		{\huge\bfseries Eyléa Piouceau}\\[0.8em]
		+33\,7\,81\,61\,89\,65 $\diamond$ \texttt{eylea.piouceau@ens-paris-saclay.fr}\\[0.5em]
		6 rue Jalna, 78370 Plaisir, France\\[0.8em]
		\textbf{Objet : Candidature pour le Master 2 Génétique de l'Université Paris Cité (2026-2027)}
	\end{minipage}%
	\begin{minipage}[c]{0.22\textwidth}
	\end{minipage}
...
\begin{rSection}{Formation}
	...
	Master 2 Formation à l'Enseignement Supérieur en Sciences du Vivant (Agrégation Biochimie-Biologie-Biotechnologie) \\
	Admissible à l'agrégation (concours externe 2026) \hfill \\
	...
	Master 1 Biologie-Santé voie Boris Ephrussi \hfill \textit{Gif-sur-Yvette, France} \\
...
\begin{rSection}{Expériences professionnelles}
	...
	\begin{rSubsection}{Stagiaire à Hubrecht Institute}{June 2025 - July 2025}{Stage de 6 semaines dans l'équipe 'Gene Expression Dynamics' dirigée par Marvin Tanenbaum.}{Utrecht, Pays-Bas}
		\item En tant que chercheur stagiaire, j'ai étudié l'impact de l'optimalité des codons sur la dynamique de l’élongation de la traduction par imagerie en cellule vivante d’ARN circulaires. J’ai réalisé des acquisitions d’images fluorescentes de cellules humaines par microscopie confocale à disque rotatif et analysé les données avec le logiciel TransTrack.
	\end{rSubsection}
	...
	\begin{rSubsection}{Stagiaire à l'IBPC (Institut de Biologie Physico-Chimique)}{Juin 2023 - Juillet 2023}{Stage de 2 mois dans l'unité 'Expression Génétique Microbienne (UMR8261 CNRS), dirigée par Ciarán Condon.}{Paris, France}
		\item En tant que chercheur stagiaire au sein de l'équipe ``Contrôle de l'expression génétique par les ARNs'' dirigée par Maude Guillier, j'ai étudié la régulation de l'expression des gènes chez \textit{Escherichia coli.} J'ai utilisé différentes techniques expérimentales telles que la transformation bactérienne, la PCR, le northern blot et des mesures de l’activité $\beta$-galactosidase.

	\end{rSubsection}

%------------------------------------------------

	\begin{rSubsection}{Étudiant vacataire - Relecture de cours, Université de Versailles Saint-Quentin-en-Yvelines}{Mai 2023 - Juin 2023}{Correction de cours dans le cadre du projet HILISIT (Hybridation en LIcence ScIenTifique)}{Versailles, France}
		\item J'ai été sélectionnée pour relire et corriger des cours rédigés par des enseignants-chercheurs sur les principaux chapitres de biologie moléculaire de licence, ayant pour vocation de devenir des ressources en ligne.
	\end{rSubsection}
...
\begin{rSection}{Compétences linguistiques et techniques}
	...
	\begin{itemize}[noitemsep, topsep=0pt, left=0pt]
		\item Anglais : niveau C1 (score de 7.5/9 à l'IELTS). Certifiée en anglais scientifique (SWAP - Scientific Writing Assessment Program).
...
\begin{rReferences}
	...
	\item \textit{Référente scientifique :} Marloes van Drimmelen, doctorante à l'Institut Hubrecht $\diamond$ \href{mailto:m.drimmelen@hubrecht.nl}{m.drimmelen@hubrecht.nl}
