...
\begin{document}
	...
	\noindent
		...
		6 rue Jalna, 78370 Plaisir, France\\[0.8em]
			\textbf{Objet : Inscription au Cours Pasteur "Analyse des génomes" (2026) dans le cadre du Master 2 Génétique de l'Université Paris Cité}
	\end{minipage}%
		\begin{minipage}[c]{0.16\textwidth}
		\end{minipage}
...
\begin{rSection}{Formation}
	...
	Admise au concours externe de l'Agrégation Biochimie-Biologie-Biotechnologie (admise rang 2) \hfill \\
