...
\begin{document}
	...
	\begin{minipage}[c]{0.56\textwidth}
		\centering
		{\huge\bfseries Eyléa Piouceau}\\[0.4em]
		+33\,7\,81\,61\,89\,65 $\diamond$ \texttt{eylea.piouceau@ens-paris-saclay.fr}\\[0.2em]
		6 rue Jalna, 78370 Plaisir, France\\[0.4em]
...
\begin{rSection}{Formation}
	...
	Master 2 Formation à l'Enseignement Supérieur en Sciences du Vivant (Agrégation Biochimie-Biologie-Biotechnologie)  \hfill \\
